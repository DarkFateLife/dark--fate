...
import { generateWebSearch } from "@DarkFateLife/darkfate";

import { SearchResult } from "@DarkFateLife/darkfate";
...
const webSearch: Action = {
    ...
    handler: async (
        ...
        darkfateLogger.log("web search prompt received:", webSearchPrompt);

        darkfateLogger.log("Generating image with prompt:", webSearchPrompt);
        ...
        if (searchResponse && searchResponse.results.length) {
            ...
            darkfateLogger.error("search failed or returned no data.");
        }
    },
    examples: [
        [
