...
import { composeContext, darkfateLogger, ServiceType } from "@DarkFateLife/darkfate";
...
import { generateMessageResponse, generateShouldRespond } from "@DarkFateLife/darkfate";
import { messageCompletionFooter, shouldRespondFooter } from "@DarkFateLife/darkfate";
...
export class MessageManager {
    ...
    public async handleMessage(ctx: Context): Promise<void> {
        ...
        try {
            ...
            darkfateLogger.error("Error sending message:", error);
        }
    }
}
