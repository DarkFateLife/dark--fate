...
export const createCoinbaseChargeAction: Action = {
    ...
    handler: async (
        ...
        darkfateLogger.log("Charge details received:", chargeDetails);
...
export const getAllChargesAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            darkfateLogger.log("Fetched all charges:", charges);
            ...
            darkfateLogger.error("Error fetching all charges:", error);
            callback(
                {
...
export const getChargeDetailsAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            darkfateLogger.log("Fetched charge details:", chargeDetails);
...
export const chargeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        ...
        darkfateLogger.log("Charges:", formattedCharges);
