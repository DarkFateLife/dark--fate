...
export const deployTokenContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        darkfateLogger.log("Validating runtime for DEPLOY_TOKEN_CONTRACT...");
        return (
            !!(
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting DEPLOY_TOKEN_CONTRACT handler...");
        ...
        try {
            ...
            darkfateLogger.log("Contract details:", contractDetails.object);
            ...
            await contract.wait();
            darkfateLogger.log("Deployment details:", deploymentDetails);
            darkfateLogger.log("Contract deployed successfully:", contract);
...
Contract deployment has been logged to the CSV file.`,
            ...
            darkfateLogger.error("Error deploying token contract:", error);
            callback(
                {
...
export const invokeContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        darkfateLogger.log("Validating runtime for INVOKE_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting INVOKE_CONTRACT handler...");
        ...
        try {
            ...
            darkfateLogger.log("Invocation details:", invocationDetails.object);
            ...
            darkfateLogger.log("Invocation options:", invocationOptions);
            // Invoke the contract
...
Contract invocation has been logged to the CSV file.`,
            ...
            darkfateLogger.error("Error invoking contract method:", error);
            callback(
                {
...
export const readContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        darkfateLogger.log("Validating runtime for READ_CONTRACT...");
        return !!(
            runtime.character.settings.secrets?.COINBASE_API_KEY ||
            process.env.COINBASE_API_KEY
        ) && !!(
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting READ_CONTRACT handler...");
        ...
        try {
            ...
            darkfateLogger.log("Reading contract:", { contractAddress, method, args, networkId, abi });
            ...
            darkfateLogger.info("Contract read result:", serializedResult);
...
- Result: ${JSON.stringify(serializedResult, null, 2)}`
            ...
            darkfateLogger.error("Error reading contract:", error);
            callback({
