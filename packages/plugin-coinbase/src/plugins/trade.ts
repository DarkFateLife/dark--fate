...
export const tradeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        try {
            ...
            darkfateLogger.log("Reading CSV file from:", tradeCsvFilePath);
...
export const executeTradeAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        darkfateLogger.log("Validating runtime for EXECUTE_TRADE...");
        return (
            !!(
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting EXECUTE_TRADE handler...");
...
- Charity Transaction URL: ${transfer.getTransactionLink() || ""}`;
            ...
            darkfateLogger.error("Error during trade execution:", error);
            callback(
                {
