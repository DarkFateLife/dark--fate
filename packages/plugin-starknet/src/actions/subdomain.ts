...
export default {
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting CREATE_SUBDOMAIN handler...");
        ...
        darkfateLogger.debug("Transfer content:", content);

        // Validate transfer content
        if (!isSubdomainCreation(content)) {
            darkfateLogger.error("Invalid content for CREATE_SUBDOMAIN action.");
            if (callback) {
                callback({
        ...
        try {
            ...
            darkfateLogger.error("Error during subdomain transfer:", error);
            if (callback) {
                callback({
