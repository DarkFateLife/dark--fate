...
export class Cache {
    ...
    constructor() {
        ...
        // Find the 'darkfate' folder in the filepath and adjust the cache directory path
        const darkfateIndex = __dirname.indexOf("darkfate");
        if (darkfateIndex !== -1) {
            const pathToEliza = __dirname.slice(0, darkfateIndex + 5); // include 'darkfate'
