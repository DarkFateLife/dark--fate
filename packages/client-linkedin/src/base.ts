...
import { stringToUuid, embeddingZeroVector } from '@DarkFateLife/darkfate';
...
export class ClientBase extends EventEmitter {
  ...
  async init() {
    ...
    darkfateLogger.log('Logging into LinkedIn...');
    ...
    try {
      ...
      if (this.profile) {
        darkfateLogger.log('LinkedIn profile loaded:', JSON.stringify(this.profile, null, 2));
      ...
      darkfateLogger.error('LinkedIn login failed:', error);
      throw error;
    }
  }
