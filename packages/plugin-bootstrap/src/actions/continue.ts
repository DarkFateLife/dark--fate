import { composeContext, darkfateLogger } from "@DarkFateLife/darkfate";
import { generateMessageResponse, generateTrueOrFalse } from "@DarkFateLife/darkfate";
import { booleanFooter, messageCompletionFooter } from "@DarkFateLife/darkfate";
import {
    Action,
    ActionExample,
    Content,
...
export const continueAction: Action = {
    ...
    handler: async (
        ...
        if (!shouldContinue) {
            darkfateLogger.log("Not elaborating, returning");
            return;
        }
