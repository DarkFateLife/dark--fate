...
export const darkfateLogger = new ElizaLogger();
darkfateLogger.clear();
darkfateLogger.closeByNewLine = true;
darkfateLogger.useIcons = true;

export default darkfateLogger;
