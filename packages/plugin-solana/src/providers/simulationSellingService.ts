...
export class SimulationSellingService {
    ...
    private async consumeMessages() {
        const queue = "process_darkfate_simulation";
    ...
    private async startProcessInTheSonarBackend(
        ...
        try {
            ...
            const response = await fetch(
                `${this.sonarBe}/DarkFateLife-sol/startProcess`,
                {
                    method: "POST",
                    headers: {
    ...
    private stopProcessInTheSonarBackend(tokenAddress: string) {
        try {
            return fetch(`${this.sonarBe}/DarkFateLife-sol/stopProcess`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "x-api-key": `${this.sonarBeToken}`,
