...
import { darkfateLogger, settings } from "@DarkFateLife/darkfate";
...
import { generateObjectDEPRECATED } from "@DarkFateLife/darkfate";
...
export default {
    ...
    handler: async (
        ...
        darkfateLogger.log("Starting SEND_TOKEN handler...");
