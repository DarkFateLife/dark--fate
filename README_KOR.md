...
<div align="center">
  ...
  📖 [문서](https://DarkFateLife.github.io/darkfate/) | 🎯 [예시](https://github.com/thejoven/awesome-darkfate)
...
[문서](https://DarkFateLife.github.io/darkfate/)를 참고하여 Eliza를 커스마이징 방법을 확인하세요.
...
[![Gitpod로 열기](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/DarkFateLife/darkfate/tree/main)
...
-   [Github Issues](https://github.com/DarkFateLife/darkfate/issues). 용도: Eliza 사용 중 발견된 버그 리포트, 기능 제안.
-   [Discord](https://discord.gg/DarkFateLife). 용도: 애플리케이션 공유 및 커뮤니티 활동.
