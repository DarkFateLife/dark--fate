...
2. Send an email to security@darkfate.builders with:
...
-   Security Issues: security@darkfate.builders
-   General Questions: Join our [Discord](https://discord.gg/DarkFateLife)
-   Updates: Follow our [security advisory page](https://github.com/DarkFateLife/darkfate/security/advisories)
