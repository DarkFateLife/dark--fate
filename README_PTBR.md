...
Para evitar conflitos no diretório core, recomendamos adicionar ações personalizadas a um diretório `custom_actions` e depois adicioná-las ao arquivo `darkfateConfig.yaml`. Veja o arquivo `darkfateConfig.example.yaml` para um exemplo.
