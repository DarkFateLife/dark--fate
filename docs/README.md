...
# https://github.com/DarkFateLife/darkfate

# Visit https://darkfate.builders for support
...
To avoid git clashes in the core directory, we recommend adding custom actions to a `custom_actions` directory and then adding them to the `darkfateConfig.yaml` file. See the `darkfateConfig.example.yaml` file for an example.
