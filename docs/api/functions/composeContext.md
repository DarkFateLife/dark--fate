[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / composeContext
...
[packages/core/src/context.ts:24](https://github.com/monilpat/darkfate/blob/main/packages/core/src/context.ts#L24)
