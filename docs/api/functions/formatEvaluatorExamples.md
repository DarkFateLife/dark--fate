[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / formatEvaluatorExamples
...
[packages/core/src/evaluators.ts:55](https://github.com/monilpat/darkfate/blob/main/packages/core/src/evaluators.ts#L55)
