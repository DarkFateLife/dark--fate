[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / formatEvaluatorExampleDescriptions
...
[packages/core/src/evaluators.ts:110](https://github.com/monilpat/darkfate/blob/main/packages/core/src/evaluators.ts#L110)
