[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / formatEvaluatorNames
...
[packages/core/src/evaluators.ts:30](https://github.com/monilpat/darkfate/blob/main/packages/core/src/evaluators.ts#L30)
