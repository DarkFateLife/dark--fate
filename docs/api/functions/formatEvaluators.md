[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / formatEvaluators
...
[packages/core/src/evaluators.ts:41](https://github.com/monilpat/darkfate/blob/main/packages/core/src/evaluators.ts#L41)
