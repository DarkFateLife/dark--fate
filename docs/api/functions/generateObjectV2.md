[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / generateObjectV2
...
[packages/core/src/generation.ts:1088](https://github.com/monilpat/darkfate/blob/main/packages/core/src/generation.ts#L1088)
