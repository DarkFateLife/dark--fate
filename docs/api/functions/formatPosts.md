[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / formatPosts
...
[packages/core/src/posts.ts:4](https://github.com/monilpat/darkfate/blob/main/packages/core/src/posts.ts#L4)
