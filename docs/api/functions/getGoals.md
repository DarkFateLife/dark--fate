[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / getGoals
...
[packages/core/src/goals.ts:8](https://github.com/monilpat/darkfate/blob/main/packages/core/src/goals.ts#L8)
