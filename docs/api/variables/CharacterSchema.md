[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / CharacterSchema
...
[packages/core/src/environment.ts:66](https://github.com/monilpat/darkfate/blob/main/packages/core/src/environment.ts#L66)
