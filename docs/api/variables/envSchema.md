[@DarkFateLife/darkfate v0.1.5-alpha.3](../index.md) / envSchema
...
[packages/core/src/environment.ts:5](https://github.com/monilpat/darkfate/blob/main/packages/core/src/environment.ts#L5)
