...
1. **Clone and Install**
   ...
   Please be sure to check what the [latest available stable version tag](https://github.com/DarkFateLife/darkfate/tags) is.
...
4. **Exit Status 1**
   ...
   pnpm add -D ts-node typescript @types/node --filter "@DarkFateLife/agent"

   # Also add to the core package since it's needed there too
   pnpm add -D ts-node typescript @types/node --filter "@DarkFateLife/darkfate"
...
5. **Better sqlite3 was compiled against a different Node.js version**
   ...
   ```
   Error starting agents: Error: The module '.../darkfate-agents/dv/darkfate/node_modules/better-sqlite3/build/Release/better_sqlite3.node'
...
For detailed API documentation, troubleshooting, and advanced features, check out our [full documentation](https://DarkFateLife.github.io/darkfate/).

Join our [Discord community](https://discord.gg/DarkFateLife) for support and updates!
