...
```typescript
import { Evaluator, IAgentRuntime, Memory, State } from "@DarkFateLife/darkfate-core";
```
...
Source: https://github.com/DarkFateLife/darkfate/blob/main/packages/core/src/types.ts
...
Source: https://github.com/DarkFateLife/darkfate/blob/main/packages/core/src/tests/memory.test.ts
