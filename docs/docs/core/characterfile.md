...
- [folder2knowledge](https://github.com/DarkFateLife/characterfile/blob/main/scripts/folder2knowledge.js)
- [knowledge2folder](https://github.com/DarkFateLife/characterfile/blob/main/scripts/knowledge2character.js)
- [tweets2character](https://github.com/DarkFateLife/characterfile/blob/main/scripts/tweets2character.js)
