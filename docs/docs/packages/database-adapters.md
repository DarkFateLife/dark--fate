...
- **PostgreSQL Adapter** (`@darkfate/adapter-postgres`) - Production-ready adapter for PostgreSQL databases
- **SQLite Adapter** (`@darkfate/adapter-sqlite`) - Lightweight adapter for SQLite, perfect for development
- **SQL.js Adapter** (`@darkfate/adapter-sqljs`) - In-memory SQLite adapter for testing
- **Supabase Adapter** (`@darkfate/adapter-supabase`) - Cloud-native adapter for Supabase

## Installation

```bash
# PostgreSQL
pnpm add @darkfate/adapter-postgres

# SQLite
pnpm add @darkfate/adapter-sqlite

# SQL.js
pnpm add @darkfate/adapter-sqljs

# Supabase
pnpm add @darkfate/adapter-supabase
```
...
```typescript
import { SqliteDatabaseAdapter } from "@darkfate/adapter-sqlite";
...
```typescript
import { PostgresDatabaseAdapter } from "@darkfate/adapter-postgres";
...
```typescript
import { SupabaseDatabaseAdapter } from "@darkfate/adapter-supabase";
