...
- **PostgreSQL** (`@DarkFateLife/adapter-postgres`)

  - Production-ready with vector search
  - Connection pooling and high performance
  - JSONB and pgvector support

- **SQLite** (`@DarkFateLife/adapter-sqlite`)

  - Lightweight local development
  - No external dependencies
  - Full-text search capabilities

- **Supabase** (`@DarkFateLife/adapter-supabase`)

  - Cloud-native PostgreSQL
  - Real-time subscriptions
  - Built-in RPC functions

- **SQL.js** (`@DarkFateLife/adapter-sqljs`)
...
```bash
# PostgreSQL
pnpm add @DarkFateLife/adapter-postgres pg

# SQLite
pnpm add @DarkFateLife/adapter-sqlite better-sqlite3

# SQL.js
pnpm add @DarkFateLife/adapter-sqljs sql.js

# Supabase
pnpm add @DarkFateLife/adapter-supabase @supabase/supabase-js
```
...
```typescript
import { SupabaseDatabaseAdapter } from "@DarkFateLife/adapter-supabase";
