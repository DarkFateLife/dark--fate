...
The Core Package (`@DarkFateLife/core`) provides the fundamental building blocks of Eliza's architecture, handling essential functionalities like:
...
```typescript
import { AgentRuntime } from "@DarkFateLife/core";
