...
```bash
pnpm add @DarkFateLife/plugin-[name]
```

2. Import and register the plugin in your character configuration:

```typescript
import { bootstrapPlugin } from "@darkfate/plugin-bootstrap";
import { imageGenerationPlugin } from "@darkfate/plugin-image-generation";
import { buttplugPlugin } from "@darkfate/plugin-buttplug";
const character = {
...
#### 1. Bootstrap Plugin (`@darkfate/plugin-bootstrap`)
...
#### 2. Image Generation Plugin (`@darkfate/plugin-image-generation`)
...
#### 3. Node Plugin (`@darkfate/plugin-node`)
...
#### 4. Solana Plugin (`@darkfate/plugin-solana`)
...
#### 5. Coinbase Commerce Plugin (`@darkfate/plugin-coinbase`)
...
#### 6. Coinbase MassPayments Plugin (`@darkfate/plugin-coinbase`)
...
1. **Configure the Plugin**
   Add the plugin to your character's configuration:
    ...
    ```typescript
    import { coinbaseMassPaymentsPlugin } from "@darkfate/plugin-coinbase-masspayments";
...
#### 8. Coinbase Token Contract Plugin (`@darkfate/plugin-coinbase`)
...
1. **Configure the Plugin**
   Add the plugin to your character's configuration:
    ...
    ```typescript
    import { tokenContractPlugin } from "@darkfate/plugin-coinbase";
...
#### 7. TEE Plugin (`@DarkFateLife/plugin-tee`)
...
```typescript
import { RemoteAttestationProvider } from "@DarkFateLife/plugin-tee";
// Initialize the provider
...
#### 9. Webhook Plugin (`@darkfate/plugin-coinbase-webhooks`)
...
1. **Configure the Plugin**
   ...
   ```typescript
   import { webhookPlugin } from "@darkfate/plugin-coinbase-webhooks";
...
```typescript
import { Plugin, Action, Evaluator, Provider } from "@DarkFateLife/darkfate";
