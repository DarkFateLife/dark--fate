...
<div align="center">
  ...
  📖 [Документация](https://DarkFateLife.github.io/darkfate/) | 🎯 [Примеры](https://github.com/thejoven/awesome-darkfate)
...
-   [GitHub Issues](https://github.com/DarkFateLife/darkfate/issues). Лучше всего подходит для: сообщений об ошибках при использовании Eliza и предложений новых функций.
-   [Discord](https://discord.gg/DarkFateLife). Лучше всего подходит для: обмена своими приложениями и общения с сообществом.
...
[![График истории звёзд](https://api.star-history.com/svg?repos=DarkFateLife/darkfate&type=Date)](https://star-history.com/#DarkFateLife/darkfate&Date)
